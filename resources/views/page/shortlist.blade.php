					...
					<li class="card listing shortlist clickable" ng-repeat="(key,value) in shortlistData track by $index | orderBy: orderName:reverse">
						...
						<a  class="projectListingsClickThrough">
					        <div class="media-wrap crop-image" style="overflow: hidden; position: relative;">
					                <img src="[:value[0].PicFile:]" alt="[:value[0].ER_No:] [:value[0].ER_St:], [:value[0].ER_Suburb:]" class="" style="position: absolute; width: 320px; height: auto; top: -11.5px; left: 0px;">
					        </div>
					    </a>
					        ...
					        <div class="inner-wrap">
					            <a class="projectListingsClickThrough">
					                <div class="price-wrap">
					                    ...
					                    <ul class="features">
					                            <li class="truncate-single">[:value[0].ER_BedRoom:] <i class="fa fa-bed"></i> [:value[0].ER_BathRoom:] <i class="fa fa-bath"></i> [:value[0].ER_Parking:] <i class="fa fa-car"></i></li>
